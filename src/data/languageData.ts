...
export const projectsLanguage =  {
    ...
    esp:  {
        ...
        projects: [
            ...
            {
                title: "store api rest",
                overview: "Una aplicación que permite al usuario crear, modificar, consultar y  eliminar entidades tales como productos, clientes, y pedidos. El acceso a cada endpoint es según el rol del usuario.",
                technologies: ["Node.js", "Express", "PostgreSQL", "Sequelize", "Swagger", "JWT"],
                urlImage: "/assets/images/projects-mystore.png",
                linkToRepo : "https://github.com/SandroSimonOre/my-store",
